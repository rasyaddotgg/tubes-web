            ...
            <div class="card-header pb-0">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <form action="" method="post" id="text-editor">
                        <input type="hidden" name="no" value="<?= $table3b72['no'] ?>" />
                        <div class="form-group mb-3">
                            <label for="luaran_penelitian">Luaran Penelitian</label>
                            <input type="text" name="luaran_penelitian" class="form-control" 
                                placeholder="table3b72 luaran_penelitian" value="<?= $table3b72['luaran_penelitian'] ?>" required>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <?php
                                ...
                                $tahunTerpilih = $table3b72['tahun']; // Ambil tahun yang sudah tersimpan dari data yang akan diedit
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="keterangan" class="form-control" 
                                placeholder="table3b72 keterangan" value="<?= $table3b72['keterangan'] ?>" required>
                        </div>
