            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table table-hover align-items-center mb-0">
                  ...
                  <tbody>
                  <?php $no=1; foreach ($table3b71 as $table3b71): ?>
                    <tr>
                     <td class="text-center">
                          <p class="mb-0 text-sm"><?= $no; ?></p>
                     </td>
                      <td class="text-center">
                            <p class="mb-0 text-sm"><?= $table3b71['luaran_penelitian'] ?></p>
                      </td>

                      <td class="text-center">
                        <p class="mb-0 text-sm"><?= $table3b71['tahun'] ?></p>
                      </td>
                      <td class="text-center">
                        ...
                        <div class="card-header pb-0 text-left">
                          <h3 class="font-weight-bolder text-primary text-gradient">Tabel 3b71</h3>
                            ...
                            <div class="card-body pb-3">
                              <form action="<?= base_url('table/table3b71/new') ?>"  method="post" role="form text-left">
